...
function CreateReviewForm({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (axios.isAxiosError(err) && err.response?.status === 409) {
        toast.error("You have already reviewed this teacher. Please edit your existing review.");
        setServerError("You have already submitted a review for this teacher. Please edit your existing review instead.");
        return;
      }
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5 py-2">
      ...
      {/* Review Title */}
      <Field>
        <FieldLabel htmlFor="reviewTitle">Headline / Summary *</FieldLabel>
        <Input
          id="reviewTitle"
      ...
      <Field>
        <FieldLabel htmlFor="reviewDescription">Detailed Feedback (Optional)</FieldLabel>
        <Textarea
