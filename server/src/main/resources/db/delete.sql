...
DROP TABLE IF EXISTS COMMUNITY_JOIN_CODES CASCADE;
...
DROP TYPE IF EXISTS POST_NOTIFICATION_TYPE CASCADE;
DROP TYPE IF EXISTS SYSTEM_NOTIFICATION_TYPE CASCADE;
