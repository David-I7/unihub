...
VALUES
    (gen_random_uuid(), 'f0000001-0000-0000-0000-000000000001'::uuid, 'e0000001-0000-0000-0000-000000000001'::uuid, 'Multumim mult pentru ghid! Este extrem de util pentru noi.', now() - interval '24 days', now() - interval '24 days'),
...
-- =====================================================================================================================
INSERT INTO EVENTS (id, title, description, type, start_time, end_time, duration_minutes, location, location_details, course_id, community_id, owner_id, created_at, updated_at)
SELECT e.id, e.title, e.description, e.type::event_type, e.start_time, e.end_time, e.duration_minutes, e.location::event_location, e.location_details, c.id, 'a0000001-0000-0000-0000-000000000001'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, now() - interval '15 days', now() - interval '15 days'
FROM (VALUES
    -- Exams
    ('a0000002-0000-0000-0000-000000000001'::uuid, 'Examen Scris Programarea Calculatoarelor', 'Examen final grila si probleme practice de cod pe foaie.', 'EXAM', now() + interval '10 days', now() + interval '10 days' + interval '3 hours', 180, 'IN_PERSON', 'Amfiteatrul EC001, Corp ED', 'programarea-calculatoarelor'),
    ('a0000002-0000-0000-0000-000000000002'::uuid, 'Colocviu Practic Structuri de Date', 'Implementare structuri de date pe calculator in mediul Linux.', 'EXAM', now() + interval '14 days', now() + interval '14 days' + interval '2 hours', 120, 'IN_PERSON', 'Laborator PR001, Corp PRECIS', 'structuri-de-date-si-algoritmi'),
    ('a0000002-0000-0000-0000-000000000003'::uuid, 'Examen Scris Analiza Matematica', 'Subiecte de calcul integral si serii numerice.', 'EXAM', now() + interval '18 days', now() + interval '18 days' + interval '3 hours', 180, 'IN_PERSON', 'Sala AN010, Corp Rectorat', 'analiza-matematica'),
    ('a0000002-0000-0000-0000-000000000004'::uuid, 'Examen Final Arhitectura Sistemelor de Calcul', 'Probleme de set de instructiuni MIPS, pipeline si organizare memorie cache.', 'EXAM', now() + interval '22 days', now() + interval '22 days' + interval '2 hours', 120, 'IN_PERSON', 'Amfiteatrul ED011, Corp ED', 'arhitectura-sistemelor-de-calcul'),
    ('a0000002-0000-0000-0000-000000000005'::uuid, 'Colocviu Proiectare Logica', 'Verificare circuite secventiale pe placi FPGA.', 'EXAM', now() + interval '8 days', now() + interval '8 days' + interval '2 hours', 120, 'IN_PERSON', 'Lab EF210, Corp Electro', 'proiectare-logica'),
    ('a0000002-0000-0000-0000-000000000006'::uuid, 'Examen Scris Sisteme de Operare', 'Gestiunea proceselor, apeluri de sistem si sincronizare.', 'EXAM', now() + interval '25 days', now() + interval '25 days' + interval '3 hours', 180, 'IN_PERSON', 'Amfiteatrul EC101, Corp ED', 'sisteme-de-operare'),
    -- Assignments & Project Deadlines
    ('a0000002-0000-0000-0000-000000000007'::uuid, 'Termen Limita Tema 1 - Pointeri si Memorie Dinamica', 'Incarcarea arhivelor pe Moodle pana la ora 23:59.', 'ASSIGNMENT', now() + interval '3 days', now() + interval '3 days', NULL, 'ONLINE', 'Platforma Moodle ACS', 'programarea-calculatoarelor'),
    ('a0000002-0000-0000-0000-000000000008'::uuid, 'Termen Limita Tema 2 - Simulator Procesor MIPS', 'Predare cod sursa MIPS Assembly pe GitHub Classroom.', 'ASSIGNMENT', now() + interval '12 days', now() + interval '12 days', NULL, 'ONLINE', 'GitHub Classroom', 'arhitectura-sistemelor-de-calcul'),
    ('a0000002-0000-0000-0000-000000000009'::uuid, 'Predare Proiect Baze de Date - Schema Relationala', 'Livrarea documentatiei si a scriptului SQL DDL.', 'ASSIGNMENT', now() + interval '16 days', now() + interval '16 days', NULL, 'ONLINE', 'Platforma Moodle', 'baze-de-date'),
    ('a0000002-0000-0000-0000-000000000010'::uuid, 'Predare Tema 1 SO - Mini-Shell Linux', 'Implementare interpretor comenzi cu procese si pipe-uri.', 'ASSIGNMENT', now() + interval '7 days', now() + interval '7 days', NULL, 'ONLINE', 'Sistem de testare automata SO', 'sisteme-de-operare'),
    ('a0000002-0000-0000-0000-000000000011'::uuid, 'Prezentare Proiect OOP - Aplicatie Desktop', 'Sustinerea orala a proiectului in fata asistentului.', 'ASSIGNMENT', now() + interval '20 days', now() + interval '20 days' + interval '4 hours', 240, 'HYBRID', 'Sala PR705 / Teams', 'programare-orientata-pe-obiecte'),
    -- Lectures & Workshops
    ('a0000002-0000-0000-0000-000000000012'::uuid, 'Curs Special - Inteligenta Artificiala Generativa', 'Prelegere sustinuta de un cercetator invitat din industria tech.', 'LECTURE', now() + interval '5 days', now() + interval '5 days' + interval '2 hours', 120, 'HYBRID', 'Amfiteatrul PRECIS PR001 + Transmisie Zoom', 'inteligenta-artificiala'),
    ('a0000002-0000-0000-0000-000000000013'::uuid, 'Workshop Securitate Cibernetica & CTF Intro', 'Exercitii practice de binary exploitation si web security.', 'LECTURE', now() + interval '6 days', now() + interval '6 days' + interval '3 hours', 180, 'IN_PERSON', 'Lab PRECIS 301', 'securitate-software'),
    ('a0000002-0000-0000-0000-000000000014'::uuid, 'Seminar Pregatire Examen Analiza Matematica', 'Rezolvari de subiecte din anii trecuti si sesiune de intrebari.', 'LECTURE', now() + interval '15 days', now() + interval '15 days' + interval '2 hours', 120, 'HYBRID', 'Sala AN010 + Microsoft Teams', 'analiza-matematica'),
    ('a0000002-0000-0000-0000-000000000015'::uuid, 'Prezentare Tehnica - Arhitecturi Cloud Moderne', 'Sisteme distribuite, Kubernetes si microservicii scalabile.', 'LECTURE', now() + interval '9 days', now() + interval '9 days' + interval '2 hours', 120, 'ONLINE', 'Google Meet Link in anunt', 'cloud-computing'),
    ('a0000002-0000-0000-0000-000000000016'::uuid, 'Curs Festiv Deschidere An Universitar', 'Intalnirea intregii comunitati academice ACS.', 'LECTURE', now() - interval '28 days', now() - interval '28 days' + interval '2 hours', 120, 'IN_PERSON', 'Aula Magna UPB', 'programarea-calculatoarelor')
) AS e(id, title, description, type, start_time, end_time, duration_minutes, location, location_details, course_slug)
...
VALUES
    ...
    ('f0000002-0000-0000-0000-000000000001'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'Reminder: Examen Scris Programarea Calculatoarelor', 'Examenul incepe in curand in amfiteatrul EC001.', 'EVENT', false, now() - interval '1 hour'),
    ('f0000002-0000-0000-0000-000000000002'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'Reminder: Termen Limita Tema 1 - Pointeri', 'Au mai ramas 2 ore pana la inchiderea formularului de predare.', 'EVENT', false, now() - interval '3 hours'),
    ('f0000002-0000-0000-0000-000000000003'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'Modificare sala: Examen Scris Analiza Matematica', 'Examenul a fost mutat in sala AN010 Corp Rectorat.', 'EVENT', false, now() - interval '6 hours'),
    ('f0000002-0000-0000-0000-000000000004'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'Actualizare orar: Workshop Securitate Cibernetica', 'Workshop-ul va incepe cu 30 de minute mai tarziu.', 'EVENT', false, now() - interval '10 hours'),
    ('f0000002-0000-0000-0000-000000000005'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'Anulare sesiune: Consultatii Metode Numerice', 'Sesiunea de consultatii de marti a fost anulata.', 'EVENT', true, now() - interval '1 day'),
    ('f0000002-0000-0000-0000-000000000006'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'Reminder: Colocviu Practic Structuri de Date', 'Nu uitati sa aveti la voi carnetul de student.', 'EVENT', true, now() - interval '2 days'),
    ('f0000002-0000-0000-0000-000000000007'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'Prelungire termen: Tema 2 - Simulator MIPS', 'Termenul de predare a fost extins cu 48 de ore.', 'EVENT', false, now() - interval '3 days'),
    ('f0000002-0000-0000-0000-000000000008'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'Reminder: Prezentare Tehnica Arhitecturi Cloud', 'Evenimentul online incepe in 15 minute pe Google Meet.', 'EVENT', true, now() - interval '4 days'),

    -- 9-20: POST notifications
    ('f0000002-0000-0000-0000-000000000009'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'Postare noua in comunitate', 'alex_popa a postat: Inscrieri deschise pentru Hackathon-ul ACS.', 'POST', false, now() - interval '5 hours'),
    ('f0000002-0000-0000-0000-000000000010'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'Postare noua la Programarea Calculatoarelor', 'maria_ionescu a postat: Diferenta intre malloc() si calloc().', 'POST', false, now() - interval '8 hours'),
    ('f0000002-0000-0000-0000-000000000011'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'Comentariu nou la postarea ta', 'andrei_radu a adaugat un comentariu la Ghidul Bobocului.', 'POST', false, now() - interval '12 hours'),
    ('f0000002-0000-0000-0000-000000000012'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'Comentariu nou la intrebarea de laborator', 'elena_dumitru a raspuns la thread-ul despre pointeri.', 'POST', false, now() - interval '16 hours'),
    ('f0000002-0000-0000-0000-000000000013'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'alex_popa a apreciat postarea ta', 'Postarea ta despre Ghidul Bobocului a primit o apreciere.', 'POST', false, now() - interval '18 hours'),
    ('f0000002-0000-0000-0000-000000000014'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'maria_ionescu a apreciat postarea ta', 'Postarea ta a primit o apreciere noua.', 'POST', false, now() - interval '22 hours'),
    ('f0000002-0000-0000-0000-000000000015'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'Postare noua: Grup de studiu', 'elena_dumitru a creat o postare de discutii pentru teme.', 'POST', true, now() - interval '1 day'),
    ('f0000002-0000-0000-0000-000000000016'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'Postare noua la Programarea Calculatoarelor', 'ana_stoica a postat: Segment fault la citirea din fisier binar.', 'POST', false, now() - interval '2 days'),
    ('f0000002-0000-0000-0000-000000000017'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'Comentariu nou la discutia de C', 'cristian_marin a lasat o solutie pentru problema cu buffer-ul stdin.', 'POST', true, now() - interval '2 days'),
    ('f0000002-0000-0000-0000-000000000018'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'diana_gheorghe a apreciat comentariul tau', 'Comentariul tau a primit un like.', 'POST', true, now() - interval '3 days'),
    ('f0000002-0000-0000-0000-000000000019'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'Postare noua: Concursul de programare ICPC', 'mihai_florea a anuntat sesiunile de antrenament.', 'POST', false, now() - interval '4 days'),
    ('f0000002-0000-0000-0000-000000000020'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'ioana_toma a apreciat postarea ta', 'Postarea ta a primit o apreciere noua.', 'POST', true, now() - interval '5 days'),

    -- 21-25: SYSTEM notifications
    ('f0000002-0000-0000-0000-000000000021'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'Bun venit in platforma UniHub!', 'Contul tau de administrator a fost configurat cu succes.', 'SYSTEM', false, now() - interval '7 days'),
    ('f0000002-0000-0000-0000-000000000022'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'Mentenanta programata a serverului', 'Duminica intre 02:00 si 04:00 vor avea loc actualizari de securitate.', 'SYSTEM', false, now() - interval '8 days'),
    ('f0000002-0000-0000-0000-000000000023'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'Actualizare termeni si conditii', 'Termenii de utilizare au fost actualizati conform noilor reglementari.', 'SYSTEM', true, now() - interval '10 days'),
    ('f0000002-0000-0000-0000-000000000024'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'Rezultate preliminare burse', 'Listele preliminare de bursa au fost publicate la avizier.', 'SYSTEM', true, now() - interval '12 days'),
    ('f0000002-0000-0000-0000-000000000025'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'Email institutional verificat', 'Adresa ta institutionala a fost validata cu succes.', 'SYSTEM', true, now() - interval '15 days');

-- Event Notifications Sub-table
INSERT INTO EVENT_NOTIFICATIONS (id, type, event_id, actor_id)
VALUES
    ('f0000002-0000-0000-0000-000000000001'::uuid, 'REMINDER'::event_notification_type, 'a0000002-0000-0000-0000-000000000001'::uuid, NULL),
    ('f0000002-0000-0000-0000-000000000002'::uuid, 'REMINDER'::event_notification_type, 'a0000002-0000-0000-0000-000000000007'::uuid, NULL),
    ('f0000002-0000-0000-0000-000000000003'::uuid, 'UPDATED'::event_notification_type, 'a0000002-0000-0000-0000-000000000003'::uuid, 'f0000001-0000-0000-0000-000000000001'::uuid),
    ('f0000002-0000-0000-0000-000000000004'::uuid, 'UPDATED'::event_notification_type, 'a0000002-0000-0000-0000-000000000013'::uuid, 'f0000001-0000-0000-0000-000000000002'::uuid),
    ('f0000002-0000-0000-0000-000000000005'::uuid, 'CANCELLED'::event_notification_type, 'a0000002-0000-0000-0000-000000000014'::uuid, 'f0000001-0000-0000-0000-000000000003'::uuid),
    ('f0000002-0000-0000-0000-000000000006'::uuid, 'REMINDER'::event_notification_type, 'a0000002-0000-0000-0000-000000000002'::uuid, NULL),
    ('f0000002-0000-0000-0000-000000000007'::uuid, 'UPDATED'::event_notification_type, 'a0000002-0000-0000-0000-000000000008'::uuid, 'f0000001-0000-0000-0000-000000000001'::uuid),
    ('f0000002-0000-0000-0000-000000000008'::uuid, 'REMINDER'::event_notification_type, 'a0000002-0000-0000-0000-000000000015'::uuid, NULL);

-- Post Notifications Sub-table
INSERT INTO POST_NOTIFICATIONS (id, type, post_id, actor_id)
VALUES
    ('f0000002-0000-0000-0000-000000000009'::uuid, 'COMMUNITY_POST'::post_notification_type, 'e0000001-0000-0000-0000-000000000002'::uuid, 'f0000001-0000-0000-0000-000000000001'::uuid),
    ('f0000002-0000-0000-0000-000000000010'::uuid, 'COURSE_POST'::post_notification_type, 'e0000002-0000-0000-0000-000000000002'::uuid, 'f0000001-0000-0000-0000-000000000002'::uuid),
    ('f0000002-0000-0000-0000-000000000011'::uuid, 'COMMENT'::post_notification_type, 'e0000001-0000-0000-0000-000000000001'::uuid, 'f0000001-0000-0000-0000-000000000003'::uuid),
    ('f0000002-0000-0000-0000-000000000012'::uuid, 'COMMENT'::post_notification_type, 'e0000002-0000-0000-0000-000000000001'::uuid, 'f0000001-0000-0000-0000-000000000004'::uuid),
    ('f0000002-0000-0000-0000-000000000013'::uuid, 'LIKE'::post_notification_type, 'e0000001-0000-0000-0000-000000000001'::uuid, 'f0000001-0000-0000-0000-000000000001'::uuid),
    ('f0000002-0000-0000-0000-000000000014'::uuid, 'LIKE'::post_notification_type, 'e0000001-0000-0000-0000-000000000001'::uuid, 'f0000001-0000-0000-0000-000000000002'::uuid),
    ('f0000002-0000-0000-0000-000000000015'::uuid, 'COMMUNITY_POST'::post_notification_type, 'e0000001-0000-0000-0000-000000000004'::uuid, 'f0000001-0000-0000-0000-000000000004'::uuid),
    ('f0000002-0000-0000-0000-000000000016'::uuid, 'COURSE_POST'::post_notification_type, 'e0000002-0000-0000-0000-000000000003'::uuid, 'f0000001-0000-0000-0000-000000000006'::uuid),
    ('f0000002-0000-0000-0000-000000000017'::uuid, 'COMMENT'::post_notification_type, 'e0000002-0000-0000-0000-000000000005'::uuid, 'f0000001-0000-0000-0000-000000000007'::uuid),
    ('f0000002-0000-0000-0000-000000000018'::uuid, 'LIKE'::post_notification_type, 'e0000001-0000-0000-0000-000000000001'::uuid, 'f0000001-0000-0000-0000-000000000008'::uuid),
    ('f0000002-0000-0000-0000-000000000019'::uuid, 'COMMUNITY_POST'::post_notification_type, 'e0000001-0000-0000-0000-000000000013'::uuid, 'f0000001-0000-0000-0000-000000000009'::uuid),
    ('f0000002-0000-0000-0000-000000000020'::uuid, 'LIKE'::post_notification_type, 'e0000001-0000-0000-0000-000000000001'::uuid, 'f0000001-0000-0000-0000-000000000010'::uuid);

-- System Notifications Sub-table
INSERT INTO SYSTEM_NOTIFICATIONS (id, type)
VALUES
    ('f0000002-0000-0000-0000-000000000021'::uuid, 'ANNOUNCEMENT'::system_notification_type),
    ('f0000002-0000-0000-0000-000000000022'::uuid, 'MAINTENANCE'::system_notification_type),
    ('f0000002-0000-0000-0000-000000000023'::uuid, 'GENERAL'::system_notification_type),
    ('f0000002-0000-0000-0000-000000000024'::uuid, 'ANNOUNCEMENT'::system_notification_type),
    ('f0000002-0000-0000-0000-000000000025'::uuid, 'GENERAL'::system_notification_type);
