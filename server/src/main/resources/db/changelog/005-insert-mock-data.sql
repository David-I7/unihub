...
-- =====================================================================================================================
-- Base Notifications
INSERT INTO NOTIFICATIONS (id, user_id, actor_id, type, event_id, post_id, title, message, category, is_read, created_at)
VALUES
    -- 1-8: EVENT notifications
    ('f0000002-0000-0000-0000-000000000001'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, NULL, 'EVENT_REMINDER'::NOTIFICATION_TYPE, 'a0000002-0000-0000-0000-000000000001'::uuid, NULL, 'Reminder: Examen Scris Programarea Calculatoarelor', 'Examenul incepe in curand in amfiteatrul EC001.', 'EVENT'::NOTIFICATION_CATEGORY, false, now() - interval '1 hour'),
    ('f0000002-0000-0000-0000-000000000002'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, NULL, 'EVENT_REMINDER'::NOTIFICATION_TYPE, 'a0000002-0000-0000-0000-000000000007'::uuid, NULL, 'Reminder: Termen Limita Tema 1 - Pointeri', 'Au mai ramas 2 ore pana la inchiderea formularului de predare.', 'EVENT'::NOTIFICATION_CATEGORY, false, now() - interval '3 hours'),
    ('f0000002-0000-0000-0000-000000000003'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'f0000001-0000-0000-0000-000000000001'::uuid, 'EVENT_UPDATED'::NOTIFICATION_TYPE, 'a0000002-0000-0000-0000-000000000003'::uuid, NULL, 'Modificare sala: Examen Scris Analiza Matematica', 'Examenul a fost mutat in sala AN010 Corp Rectorat.', 'EVENT'::NOTIFICATION_CATEGORY, false, now() - interval '6 hours'),
    ('f0000002-0000-0000-0000-000000000004'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'f0000001-0000-0000-0000-000000000002'::uuid, 'EVENT_UPDATED'::NOTIFICATION_TYPE, 'a0000002-0000-0000-0000-000000000013'::uuid, NULL, 'Actualizare orar: Workshop Securitate Cibernetica', 'Workshop-ul va incepe cu 30 de minute mai tarziu.', 'EVENT'::NOTIFICATION_CATEGORY, false, now() - interval '10 hours'),
    ('f0000002-0000-0000-0000-000000000005'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'f0000001-0000-0000-0000-000000000003'::uuid, 'EVENT_CANCELLED'::NOTIFICATION_TYPE, 'a0000002-0000-0000-0000-000000000014'::uuid, NULL, 'Anulare sesiune: Consultatii Metode Numerice', 'Sesiunea de consultatii de marti a fost anulata.', 'EVENT'::NOTIFICATION_CATEGORY, true, now() - interval '1 day'),
    ('f0000002-0000-0000-0000-000000000006'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, NULL, 'EVENT_REMINDER'::NOTIFICATION_TYPE, 'a0000002-0000-0000-0000-000000000002'::uuid, NULL, 'Reminder: Colocviu Practic Structuri de Date', 'Nu uitati sa aveti la voi carnetul de student.', 'EVENT'::NOTIFICATION_CATEGORY, true, now() - interval '2 days'),
    ('f0000002-0000-0000-0000-000000000007'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'f0000001-0000-0000-0000-000000000001'::uuid, 'EVENT_UPDATED'::NOTIFICATION_TYPE, 'a0000002-0000-0000-0000-000000000008'::uuid, NULL, 'Prelungire termen: Tema 2 - Simulator MIPS', 'Termenul de predare a fost extins cu 48 de ore.', 'EVENT'::NOTIFICATION_CATEGORY, false, now() - interval '3 days'),
    ('f0000002-0000-0000-0000-000000000008'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, NULL, 'EVENT_REMINDER'::NOTIFICATION_TYPE, 'a0000002-0000-0000-0000-000000000015'::uuid, NULL, 'Reminder: Prezentare Tehnica Arhitecturi Cloud', 'Evenimentul online incepe in 15 minute pe Google Meet.', 'EVENT'::NOTIFICATION_CATEGORY, true, now() - interval '4 days'),

    -- 9-20: POST notifications
    ('f0000002-0000-0000-0000-000000000009'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'f0000001-0000-0000-0000-000000000001'::uuid, 'COMMUNITY_POST'::NOTIFICATION_TYPE, NULL, 'e0000001-0000-0000-0000-000000000002'::uuid, 'Postare noua in comunitate', 'alex_popa a postat: Inscrieri deschise pentru Hackathon-ul ACS.', 'POST'::NOTIFICATION_CATEGORY, false, now() - interval '5 hours'),
    ('f0000002-0000-0000-0000-000000000010'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'f0000001-0000-0000-0000-000000000002'::uuid, 'COURSE_POST'::NOTIFICATION_TYPE, NULL, 'e0000002-0000-0000-0000-000000000002'::uuid, 'Postare noua la Programarea Calculatoarelor', 'maria_ionescu a postat: Diferenta intre malloc() si calloc().', 'POST'::NOTIFICATION_CATEGORY, false, now() - interval '8 hours'),
    ('f0000002-0000-0000-0000-000000000011'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'f0000001-0000-0000-0000-000000000003'::uuid, 'POST_COMMENT'::NOTIFICATION_TYPE, NULL, 'e0000001-0000-0000-0000-000000000001'::uuid, 'Comentariu nou la postarea ta', 'andrei_radu a adaugat un comentariu la Ghidul Bobocului.', 'POST'::NOTIFICATION_CATEGORY, false, now() - interval '12 hours'),
    ('f0000002-0000-0000-0000-000000000012'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'f0000001-0000-0000-0000-000000000004'::uuid, 'POST_COMMENT'::NOTIFICATION_TYPE, NULL, 'e0000002-0000-0000-0000-000000000001'::uuid, 'Comentariu nou la intrebarea de laborator', 'elena_dumitru a raspuns la thread-ul despre pointeri.', 'POST'::NOTIFICATION_CATEGORY, false, now() - interval '16 hours'),
    ('f0000002-0000-0000-0000-000000000013'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'f0000001-0000-0000-0000-000000000001'::uuid, 'POST_LIKE'::NOTIFICATION_TYPE, NULL, 'e0000001-0000-0000-0000-000000000001'::uuid, 'alex_popa a apreciat postarea ta', 'Postarea ta despre Ghidul Bobocului a primit o apreciere.', 'POST'::NOTIFICATION_CATEGORY, false, now() - interval '18 hours'),
    ('f0000002-0000-0000-0000-000000000014'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'f0000001-0000-0000-0000-000000000002'::uuid, 'POST_LIKE'::NOTIFICATION_TYPE, NULL, 'e0000001-0000-0000-0000-000000000001'::uuid, 'maria_ionescu a apreciat postarea ta', 'Postarea ta a primit o apreciere noua.', 'POST'::NOTIFICATION_CATEGORY, false, now() - interval '22 hours'),
    ('f0000002-0000-0000-0000-000000000015'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'f0000001-0000-0000-0000-000000000004'::uuid, 'COMMUNITY_POST'::NOTIFICATION_TYPE, NULL, 'e0000001-0000-0000-0000-000000000004'::uuid, 'Postare noua: Grup de studiu', 'elena_dumitru a creat o postare de discutii pentru teme.', 'POST'::NOTIFICATION_CATEGORY, true, now() - interval '1 day'),
    ('f0000002-0000-0000-0000-000000000016'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'f0000001-0000-0000-0000-000000000006'::uuid, 'COURSE_POST'::NOTIFICATION_TYPE, NULL, 'e0000002-0000-0000-0000-000000000003'::uuid, 'Postare noua la Programarea Calculatoarelor', 'ana_stoica a postat: Segment fault la citirea din fisier binar.', 'POST'::NOTIFICATION_CATEGORY, false, now() - interval '2 days'),
    ('f0000002-0000-0000-0000-000000000017'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'f0000001-0000-0000-0000-000000000007'::uuid, 'POST_COMMENT'::NOTIFICATION_TYPE, NULL, 'e0000002-0000-0000-0000-000000000005'::uuid, 'Comentariu nou la discutia de C', 'cristian_marin a lasat o solutie pentru problema cu buffer-ul stdin.', 'POST'::NOTIFICATION_CATEGORY, true, now() - interval '2 days'),
    ('f0000002-0000-0000-0000-000000000018'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'f0000001-0000-0000-0000-000000000008'::uuid, 'POST_LIKE'::NOTIFICATION_TYPE, NULL, 'e0000001-0000-0000-0000-000000000001'::uuid, 'diana_gheorghe a apreciat comentariul tau', 'Comentariul tau a primit un like.', 'POST'::NOTIFICATION_CATEGORY, true, now() - interval '3 days'),
    ('f0000002-0000-0000-0000-000000000019'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'f0000001-0000-0000-0000-000000000009'::uuid, 'COMMUNITY_POST'::NOTIFICATION_TYPE, NULL, 'e0000001-0000-0000-0000-000000000013'::uuid, 'Postare noua: Concursul de programare ICPC', 'mihai_florea a anuntat sesiunile de antrenament.', 'POST'::NOTIFICATION_CATEGORY, false, now() - interval '4 days'),
    ('f0000002-0000-0000-0000-000000000020'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'f0000001-0000-0000-0000-000000000010'::uuid, 'POST_LIKE'::NOTIFICATION_TYPE, NULL, 'e0000001-0000-0000-0000-000000000001'::uuid, 'ioana_toma a apreciat postarea ta', 'Postarea ta a primit o apreciere noua.', 'POST'::NOTIFICATION_CATEGORY, true, now() - interval '5 days'),

    -- 21-25: SYSTEM notifications
    ('f0000002-0000-0000-0000-000000000021'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, NULL, 'SYSTEM_ANNOUNCEMENT'::NOTIFICATION_TYPE, NULL, NULL, 'Bun venit in platforma UniHub!', 'Contul tau de administrator a fost configurat cu succes.', 'SYSTEM'::NOTIFICATION_CATEGORY, false, now() - interval '7 days'),
    ('f0000002-0000-0000-0000-000000000022'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, NULL, 'SYSTEM_MAINTENANCE'::NOTIFICATION_TYPE, NULL, NULL, 'Mentenanta programata a serverului', 'Duminica intre 02:00 si 04:00 vor avea loc actualizari de securitate.', 'SYSTEM'::NOTIFICATION_CATEGORY, false, now() - interval '8 days'),
    ('f0000002-0000-0000-0000-000000000023'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, NULL, 'SYSTEM_GENERAL'::NOTIFICATION_TYPE, NULL, NULL, 'Actualizare termeni si conditii', 'Termenii de utilizare au fost actualizati conform noilor reglementari.', 'SYSTEM'::NOTIFICATION_CATEGORY, true, now() - interval '10 days'),
    ('f0000002-0000-0000-0000-000000000024'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, NULL, 'SYSTEM_ANNOUNCEMENT'::NOTIFICATION_TYPE, NULL, NULL, 'Rezultate preliminare burse', 'Listele preliminare de bursa au fost publicate la avizier.', 'SYSTEM'::NOTIFICATION_CATEGORY, true, now() - interval '12 days'),
    ('f0000002-0000-0000-0000-000000000025'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, NULL, 'SYSTEM_GENERAL'::NOTIFICATION_TYPE, NULL, NULL, 'Email institutional verificat', 'Adresa ta institutionala a fost validata cu succes.', 'SYSTEM'::NOTIFICATION_CATEGORY, true, now() - interval '15 days');
