...
-- =====================================================================================================================
-- Base Notifications
INSERT INTO NOTIFICATIONS (id, user_id, type, title, message, category, is_read, created_at, metadata)
VALUES
    -- 1-8: EVENT notifications
    ('f0000002-0000-0000-0000-000000000001'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'EVENT_REMINDER'::NOTIFICATION_TYPE, 'Reminder: Examen Scris Programarea Calculatoarelor', 'Examenul incepe in curand in amfiteatrul EC001.', 'EVENT'::NOTIFICATION_CATEGORY, false, now() - interval '1 hour', '{"eventId": "a0000002-0000-0000-0000-000000000001", "courseSlug": "programarea-calculatoarelor", "courseName": "Programarea calculatoarelor", "studyYearName": "YEAR_1", "communitySlug": "acs-upb", "communityName": "Politehnica - Automatica si Calculatoare"}'::jsonb),
    ('f0000002-0000-0000-0000-000000000002'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'EVENT_REMINDER'::NOTIFICATION_TYPE, 'Reminder: Termen Limita Tema 1 - Pointeri', 'Au mai ramas 2 ore pana la inchiderea formularului de predare.', 'EVENT'::NOTIFICATION_CATEGORY, false, now() - interval '3 hours', '{"eventId": "a0000002-0000-0000-0000-000000000007", "courseSlug": "programarea-calculatoarelor", "courseName": "Programarea calculatoarelor", "studyYearName": "YEAR_1", "communitySlug": "acs-upb", "communityName": "Politehnica - Automatica si Calculatoare"}'::jsonb),
    ('f0000002-0000-0000-0000-000000000003'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'EVENT_UPDATED'::NOTIFICATION_TYPE, 'Modificare sala: Examen Scris Analiza Matematica', 'Examenul a fost mutat in sala AN010 Corp Rectorat.', 'EVENT'::NOTIFICATION_CATEGORY, false, now() - interval '6 hours', '{"eventId": "a0000002-0000-0000-0000-000000000003", "actorId": "f0000001-0000-0000-0000-000000000001", "actorUsername": "alex_popa", "courseSlug": "analiza-matematica", "courseName": "Analiza matematica", "studyYearName": "YEAR_1", "communitySlug": "acs-upb", "communityName": "Politehnica - Automatica si Calculatoare"}'::jsonb),
    ('f0000002-0000-0000-0000-000000000004'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'EVENT_UPDATED'::NOTIFICATION_TYPE, 'Actualizare orar: Workshop Securitate Cibernetica', 'Workshop-ul va incepe cu 30 de minute mai tarziu.', 'EVENT'::NOTIFICATION_CATEGORY, false, now() - interval '10 hours', '{"eventId": "a0000002-0000-0000-0000-000000000013", "actorId": "f0000001-0000-0000-0000-000000000002", "actorUsername": "maria_ionescu", "courseSlug": "securitate-software", "courseName": "Securitate software", "studyYearName": "YEAR_3", "communitySlug": "acs-upb", "communityName": "Politehnica - Automatica si Calculatoare"}'::jsonb),
    ('f0000002-0000-0000-0000-000000000005'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'EVENT_CANCELLED'::NOTIFICATION_TYPE, 'Anulare sesiune: Consultatii Metode Numerice', 'Sesiunea de consultatii de marti a fost anulata.', 'EVENT'::NOTIFICATION_CATEGORY, true, now() - interval '1 day', '{"eventId": "a0000002-0000-0000-0000-000000000014", "actorId": "f0000001-0000-0000-0000-000000000003", "actorUsername": "andrei_radu", "courseSlug": "metode-numerice", "courseName": "Metode numerice", "studyYearName": "YEAR_1", "communitySlug": "acs-upb", "communityName": "Politehnica - Automatica si Calculatoare"}'::jsonb),
    ('f0000002-0000-0000-0000-000000000006'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'EVENT_REMINDER'::NOTIFICATION_TYPE, 'Reminder: Colocviu Practic Structuri de Date', 'Nu uitati sa aveti la voi carnetul de student.', 'EVENT'::NOTIFICATION_CATEGORY, true, now() - interval '2 days', '{"eventId": "a0000002-0000-0000-0000-000000000002", "courseSlug": "structuri-de-date-si-algoritmi", "courseName": "Structuri de date si algoritmi", "studyYearName": "YEAR_1", "communitySlug": "acs-upb", "communityName": "Politehnica - Automatica si Calculatoare"}'::jsonb),
    ('f0000002-0000-0000-0000-000000000007'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'EVENT_UPDATED'::NOTIFICATION_TYPE, 'Prelungire termen: Tema 2 - Simulator MIPS', 'Termenul de predare a fost extins cu 48 de ore.', 'EVENT'::NOTIFICATION_CATEGORY, false, now() - interval '3 days', '{"eventId": "a0000002-0000-0000-0000-000000000008", "actorId": "f0000001-0000-0000-0000-000000000001", "actorUsername": "alex_popa", "courseSlug": "arhitectura-sistemelor-de-calcul", "courseName": "Arhitectura sistemelor de calcul", "studyYearName": "YEAR_1", "communitySlug": "acs-upb", "communityName": "Politehnica - Automatica si Calculatoare"}'::jsonb),
    ('f0000002-0000-0000-0000-000000000008'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'EVENT_REMINDER'::NOTIFICATION_TYPE, 'Reminder: Prezentare Tehnica Arhitecturi Cloud', 'Evenimentul online incepe in 15 minute pe Google Meet.', 'EVENT'::NOTIFICATION_CATEGORY, true, now() - interval '4 days', '{"eventId": "a0000002-0000-0000-0000-000000000015", "courseSlug": "cloud-computing", "courseName": "Cloud computing", "studyYearName": "YEAR_4", "communitySlug": "acs-upb", "communityName": "Politehnica - Automatica si Calculatoare"}'::jsonb),

    -- 9-20: POST notifications
    ('f0000002-0000-0000-0000-000000000009'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'COMMUNITY_POST'::NOTIFICATION_TYPE, 'Postare noua in comunitate', 'alex_popa a postat: Inscrieri deschise pentru Hackathon-ul ACS.', 'POST'::NOTIFICATION_CATEGORY, false, now() - interval '5 hours', '{"actorId": "f0000001-0000-0000-0000-000000000001", "actorUsername": "alex_popa", "communitySlug": "acs-upb", "communityName": "Politehnica - Automatica si Calculatoare"}'::jsonb),
    ('f0000002-0000-0000-0000-000000000010'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'COURSE_POST'::NOTIFICATION_TYPE, 'Postare noua la Programarea Calculatoarelor', 'maria_ionescu a postat: Diferenta intre malloc() si calloc().', 'POST'::NOTIFICATION_CATEGORY, false, now() - interval '8 hours', '{"actorId": "f0000001-0000-0000-0000-000000000002", "actorUsername": "maria_ionescu", "courseSlug": "programarea-calculatoarelor", "courseName": "Programarea calculatoarelor", "studyYearName": "YEAR_1", "communitySlug": "acs-upb", "communityName": "Politehnica - Automatica si Calculatoare"}'::jsonb),
    ('f0000002-0000-0000-0000-000000000011'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'POST_COMMENT'::NOTIFICATION_TYPE, 'Comentariu nou la postarea ta', 'andrei_radu a adaugat un comentariu la Ghidul Bobocului.', 'POST'::NOTIFICATION_CATEGORY, false, now() - interval '12 hours', '{"actorId": "f0000001-0000-0000-0000-000000000003", "actorUsername": "andrei_radu", "communitySlug": "acs-upb", "communityName": "Politehnica - Automatica si Calculatoare"}'::jsonb),
    ('f0000002-0000-0000-0000-000000000012'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'POST_COMMENT'::NOTIFICATION_TYPE, 'Comentariu nou la intrebarea de laborator', 'elena_dumitru a raspuns la thread-ul despre pointeri.', 'POST'::NOTIFICATION_CATEGORY, false, now() - interval '16 hours', '{"actorId": "f0000001-0000-0000-0000-000000000004", "actorUsername": "elena_dumitru", "courseSlug": "programarea-calculatoarelor", "courseName": "Programarea calculatoarelor", "studyYearName": "YEAR_1", "communitySlug": "acs-upb", "communityName": "Politehnica - Automatica si Calculatoare"}'::jsonb),
    ('f0000002-0000-0000-0000-000000000013'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'POST_LIKE'::NOTIFICATION_TYPE, 'alex_popa a apreciat postarea ta', 'Postarea ta despre Ghidul Bobocului a primit o apreciere.', 'POST'::NOTIFICATION_CATEGORY, false, now() - interval '18 hours', '{"actorId": "f0000001-0000-0000-0000-000000000001", "actorUsername": "alex_popa", "communitySlug": "acs-upb", "communityName": "Politehnica - Automatica si Calculatoare"}'::jsonb),
    ('f0000002-0000-0000-0000-000000000014'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'POST_LIKE'::NOTIFICATION_TYPE, 'maria_ionescu a apreciat postarea ta', 'Postarea ta a primit o apreciere noua.', 'POST'::NOTIFICATION_CATEGORY, false, now() - interval '22 hours', '{"actorId": "f0000001-0000-0000-0000-000000000002", "actorUsername": "maria_ionescu", "communitySlug": "acs-upb", "communityName": "Politehnica - Automatica si Calculatoare"}'::jsonb),
    ('f0000002-0000-0000-0000-000000000015'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'COMMUNITY_POST'::NOTIFICATION_TYPE, 'Postare noua: Grup de studiu', 'elena_dumitru a creat o postare de discutii pentru teme.', 'POST'::NOTIFICATION_CATEGORY, true, now() - interval '1 day', '{"actorId": "f0000001-0000-0000-0000-000000000004", "actorUsername": "elena_dumitru", "communitySlug": "acs-upb", "communityName": "Politehnica - Automatica si Calculatoare"}'::jsonb),
    ('f0000002-0000-0000-0000-000000000016'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'COURSE_POST'::NOTIFICATION_TYPE, 'Postare noua la Programarea Calculatoarelor', 'ana_stoica a postat: Segment fault la citirea din fisier binar.', 'POST'::NOTIFICATION_CATEGORY, false, now() - interval '2 days', '{"actorId": "f0000001-0000-0000-0000-000000000006", "actorUsername": "ana_stoica", "courseSlug": "programarea-calculatoarelor", "courseName": "Programarea calculatoarelor", "studyYearName": "YEAR_1", "communitySlug": "acs-upb", "communityName": "Politehnica - Automatica si Calculatoare"}'::jsonb),
    ('f0000002-0000-0000-0000-000000000017'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'POST_COMMENT'::NOTIFICATION_TYPE, 'Comentariu nou la discutia de C', 'cristian_marin a lasat o solutie pentru problema cu buffer-ul stdin.', 'POST'::NOTIFICATION_CATEGORY, true, now() - interval '2 days', '{"actorId": "f0000001-0000-0000-0000-000000000007", "actorUsername": "cristian_marin", "courseSlug": "programarea-calculatoarelor", "courseName": "Programarea calculatoarelor", "studyYearName": "YEAR_1", "communitySlug": "acs-upb", "communityName": "Politehnica - Automatica si Calculatoare"}'::jsonb),
    ('f0000002-0000-0000-0000-000000000018'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'POST_LIKE'::NOTIFICATION_TYPE, 'diana_gheorghe a apreciat comentariul tau', 'Comentariul tau a primit un like.', 'POST'::NOTIFICATION_CATEGORY, true, now() - interval '3 days', '{"actorId": "f0000001-0000-0000-0000-000000000008", "actorUsername": "diana_gheorghe", "communitySlug": "acs-upb", "communityName": "Politehnica - Automatica si Calculatoare"}'::jsonb),
    ('f0000002-0000-0000-0000-000000000019'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'COMMUNITY_POST'::NOTIFICATION_TYPE, 'Postare noua: Concursul de programare ICPC', 'mihai_florea a anuntat sesiunile de antrenament.', 'POST'::NOTIFICATION_CATEGORY, false, now() - interval '4 days', '{"actorId": "f0000001-0000-0000-0000-000000000009", "actorUsername": "mihai_florea", "communitySlug": "acs-upb", "communityName": "Politehnica - Automatica si Calculatoare"}'::jsonb),
    ('f0000002-0000-0000-0000-000000000020'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'POST_LIKE'::NOTIFICATION_TYPE, 'ioana_toma a apreciat postarea ta', 'Postarea ta a primit o apreciere noua.', 'POST'::NOTIFICATION_CATEGORY, true, now() - interval '5 days', '{"actorId": "f0000001-0000-0000-0000-000000000010", "actorUsername": "ioana_toma", "communitySlug": "acs-upb", "communityName": "Politehnica - Automatica si Calculatoare"}'::jsonb),

    -- 21-25: SYSTEM notifications
    ('f0000002-0000-0000-0000-000000000021'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'SYSTEM_ANNOUNCEMENT'::NOTIFICATION_TYPE, 'Bun venit in platforma UniHub!', 'Contul tau de administrator a fost configurat cu succes.', 'SYSTEM'::NOTIFICATION_CATEGORY, false, now() - interval '7 days', NULL),
    ('f0000002-0000-0000-0000-000000000022'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'SYSTEM_MAINTENANCE'::NOTIFICATION_TYPE, 'Mentenanta programata a serverului', 'Duminica intre 02:00 si 04:00 vor avea loc actualizari de securitate.', 'SYSTEM'::NOTIFICATION_CATEGORY, false, now() - interval '8 days', NULL),
    ('f0000002-0000-0000-0000-000000000023'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'SYSTEM_GENERAL'::NOTIFICATION_TYPE, 'Actualizare termeni si conditii', 'Termenii de utilizare au fost actualizati conform noilor reglementari.', 'SYSTEM'::NOTIFICATION_CATEGORY, true, now() - interval '10 days', NULL),
    ('f0000002-0000-0000-0000-000000000024'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'SYSTEM_ANNOUNCEMENT'::NOTIFICATION_TYPE, 'Rezultate preliminare burse', 'Listele preliminare de bursa au fost publicate la avizier.', 'SYSTEM'::NOTIFICATION_CATEGORY, true, now() - interval '12 days', NULL),
    ('f0000002-0000-0000-0000-000000000025'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'SYSTEM_GENERAL'::NOTIFICATION_TYPE, 'Email institutional verificat', 'Adresa ta institutionala a fost validata cu succes.', 'SYSTEM'::NOTIFICATION_CATEGORY, true, now() - interval '15 days', NULL);
