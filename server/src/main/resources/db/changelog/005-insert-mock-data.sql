...
VALUES
    ...
    ('f0000002-0000-0000-0000-000000000008'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'EVENT_REMINDER'::NOTIFICATION_TYPE, 'The presentation for Cloud computing starts in 15m', 'EVENT'::NOTIFICATION_CATEGORY, true, now() - interval '4 days', '{"eventId": "a0000002-0000-0000-0000-000000000015", "courseSlug": "cloud-computing", "courseName": "Cloud computing", "studyYearName": "YEAR_4", "communitySlug": "acs-upb", "communityName": "Politehnica - Automatica si Calculatoare"}'::jsonb, null),
    ...
    ('f0000002-0000-0000-0000-000000000013'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'POST_LIKE'::NOTIFICATION_TYPE, 'liked your post "Ghidul Bobocului"', 'POST'::NOTIFICATION_CATEGORY, false, now() - interval '18 hours', '{ "communitySlug": "acs-upb", "communityName": "Politehnica - Automatica si Calculatoare"}'::jsonb, 'f0000001-0000-0000-0000-000000000002'::uuid),
    ('f0000002-0000-0000-0000-000000000014'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'POST_LIKE'::NOTIFICATION_TYPE, 'liked your post "Ghidul Bobocului"', 'POST'::NOTIFICATION_CATEGORY, false, now() - interval '22 hours', '{ "communitySlug": "acs-upb", "communityName": "Politehnica - Automatica si Calculatoare"}'::jsonb, 'f0000001-0000-0000-0000-000000000001'::uuid),
    ...
    ('f0000002-0000-0000-0000-000000000018'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'POST_LIKE'::NOTIFICATION_TYPE, 'liked your post "Ghidul Bobocului"', 'POST'::NOTIFICATION_CATEGORY, true, now() - interval '3 days', '{ "communitySlug": "acs-upb", "communityName": "Politehnica - Automatica si Calculatoare"}'::jsonb, 'f0000001-0000-0000-0000-000000000004'::uuid),
    ...
    ('f0000002-0000-0000-0000-000000000020'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'POST_LIKE'::NOTIFICATION_TYPE, 'liked your post "Ghidul Bobocului"', 'POST'::NOTIFICATION_CATEGORY, true, now() - interval '5 days', '{ "communitySlug": "acs-upb", "communityName": "Politehnica - Automatica si Calculatoare"}'::jsonb, 'f0000001-0000-0000-0000-000000000001'::uuid),
