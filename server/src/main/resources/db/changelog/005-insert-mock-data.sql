...
VALUES
    ...
    ('f0000002-0000-0000-0000-000000000018'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'POST_LIKE'::NOTIFICATION_TYPE, 'diana_gheorghe a apreciat comentariul tau', 'Comentariul tau a primit un like.', 'POST'::NOTIFICATION_CATEGORY, true, now() - interval '3 days', '{ "communitySlug": "acs-upb", "communityName": "Politehnica - Automatica si Calculatoare"}'::jsonb,'f0000001-0000-0000-0000-000000000004'::uuid),
    ('f0000002-0000-0000-0000-000000000019'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'COMMUNITY_POST'::NOTIFICATION_TYPE, 'Postare noua: Concursul de programare ICPC', 'mihai_florea a anuntat sesiunile de antrenament.', 'POST'::NOTIFICATION_CATEGORY, false, now() - interval '4 days', '{ "communitySlug": "acs-upb", "communityName": "Politehnica - Automatica si Calculatoare"}'::jsonb,'f0000001-0000-0000-0000-000000000003'::uuid),
    ('f0000002-0000-0000-0000-000000000020'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'POST_LIKE'::NOTIFICATION_TYPE, 'ioana_toma a apreciat postarea ta', 'Postarea ta a primit o apreciere noua.', 'POST'::NOTIFICATION_CATEGORY, true, now() - interval '5 days', '{ "communitySlug": "acs-upb", "communityName": "Politehnica - Automatica si Calculatoare"}'::jsonb,'f0000001-0000-0000-0000-000000000001'::uuid),

    -- 21-25: SYSTEM notifications
    ('f0000002-0000-0000-0000-000000000021'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'SYSTEM_ANNOUNCEMENT'::NOTIFICATION_TYPE, 'Bun venit in platforma UniHub!', 'Contul tau de administrator a fost configurat cu succes.', 'SYSTEM'::NOTIFICATION_CATEGORY, false, now() - interval '7 days', NULL,NULL),
    ('f0000002-0000-0000-0000-000000000022'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'SYSTEM_MAINTENANCE'::NOTIFICATION_TYPE, 'Mentenanta programata a serverului', 'Duminica intre 02:00 si 04:00 vor avea loc actualizari de securitate.', 'SYSTEM'::NOTIFICATION_CATEGORY, false, now() - interval '8 days', NULL,NULL),
    ('f0000002-0000-0000-0000-000000000023'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'SYSTEM_GENERAL'::NOTIFICATION_TYPE, 'Actualizare termeni si conditii', 'Termenii de utilizare au fost actualizati conform noilor reglementari.', 'SYSTEM'::NOTIFICATION_CATEGORY, true, now() - interval '10 days', NULL,NULL),
    ('f0000002-0000-0000-0000-000000000024'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'SYSTEM_ANNOUNCEMENT'::NOTIFICATION_TYPE, 'Rezultate preliminare burse', 'Listele preliminare de bursa au fost publicate la avizier.', 'SYSTEM'::NOTIFICATION_CATEGORY, true, now() - interval '12 days', NULL,NULL),
    ('f0000002-0000-0000-0000-000000000025'::uuid, '1704ba53-75d6-478a-94e5-4618ac372540'::uuid, 'SYSTEM_GENERAL'::NOTIFICATION_TYPE, 'Email institutional verificat', 'Adresa ta institutionala a fost validata cu succes.', 'SYSTEM'::NOTIFICATION_CATEGORY, true, now() - interval '15 days', NULL,NULL);
