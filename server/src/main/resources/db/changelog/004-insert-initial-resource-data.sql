...
SELECT 'Year 1', id, now() FROM communities WHERE name = 'FMI - Informatica ID';

INSERT INTO study_years (study_year_name, community_id, created_at)
SELECT 'Year 2', id, now() FROM communities WHERE name = 'FMI - Informatica ID';

INSERT INTO study_years (study_year_name, community_id, created_at)
SELECT 'Year 3', id, now() FROM communities WHERE name = 'FMI - Informatica ID';
...
WHERE comm.name = 'FMI - Informatica ID'
  ...
  AND sy.community_id = comm.id AND sy.study_year_name = 'Year 1';
...
WHERE comm.name = 'FMI - Informatica ID'
  ...
  AND sy.community_id = comm.id AND sy.study_year_name = 'Year 2';
...
-- Insert Materials (Resources + Materials + Material Links)
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT '28a48535-ba57-5f18-862d-f4862a3fa70c'::uuid, 'Materiale curs', NULL, '35f6d7f5-545b-51a6-acaa-175d69b0de5c'::uuid, id, '2026-07-01 09:08:16.376+00', '2026-07-01 09:08:16.376+00' FROM users;
INSERT INTO materials (id) VALUES ('28a48535-ba57-5f18-862d-f4862a3fa70c'::uuid);
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT 'c2fb173f-3658-571e-adee-4eda7c7a4b25'::uuid, 'Exemple examene', NULL, '35f6d7f5-545b-51a6-acaa-175d69b0de5c'::uuid, id, '2026-07-01 09:10:27.977+00', '2026-07-01 09:10:27.977+00' FROM users;
INSERT INTO materials (id) VALUES ('c2fb173f-3658-571e-adee-4eda7c7a4b25'::uuid);
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT '9d381713-8928-5ff1-a613-3c1773e4b7c8'::uuid, 'Materiale mips', NULL, '35f6d7f5-545b-51a6-acaa-175d69b0de5c'::uuid, id, '2026-07-01 09:10:27.977+00', '2026-07-01 09:10:27.977+00' FROM users;
INSERT INTO materials (id) VALUES ('9d381713-8928-5ff1-a613-3c1773e4b7c8'::uuid);
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT '69d7f429-257f-5ae9-84fb-326071702854'::uuid, 'Materiale curs', NULL, '8f364c62-916c-5141-a410-e13dff33084f'::uuid, id, '2026-07-01 09:08:16.376+00', '2026-07-01 09:08:16.376+00' FROM users;
INSERT INTO materials (id) VALUES ('69d7f429-257f-5ae9-84fb-326071702854'::uuid);
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT '5dc84f22-850d-5534-822c-eab0ed50fed0'::uuid, 'Exemple examene', NULL, '8f364c62-916c-5141-a410-e13dff33084f'::uuid, id, '2026-07-01 09:10:27.977+00', '2026-07-01 09:10:27.977+00' FROM users;
INSERT INTO materials (id) VALUES ('5dc84f22-850d-5534-822c-eab0ed50fed0'::uuid);
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT 'f5cea941-427b-5ced-b2db-28f5df8cd67e'::uuid, 'Inregistrari cursuri', NULL, '8f364c62-916c-5141-a410-e13dff33084f'::uuid, id, '2026-07-01 08:50:00.545+00', '2026-07-01 08:50:00.545+00' FROM users;
INSERT INTO materials (id) VALUES ('f5cea941-427b-5ced-b2db-28f5df8cd67e'::uuid);
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT '335dd8a4-0208-56c7-a644-17c4d7fcbce3'::uuid, 'Materiale curs', NULL, 'a4c30f75-f9f5-5b28-a277-848dfede830b'::uuid, id, '2026-07-01 09:08:16.376+00', '2026-07-01 09:08:16.376+00' FROM users;
INSERT INTO materials (id) VALUES ('335dd8a4-0208-56c7-a644-17c4d7fcbce3'::uuid);
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT '1ef03067-8c9f-5d10-bde1-e30a3b6ce80b'::uuid, 'Exemple examene', NULL, 'a4c30f75-f9f5-5b28-a277-848dfede830b'::uuid, id, '2026-07-01 09:10:27.977+00', '2026-07-01 09:10:27.977+00' FROM users;
INSERT INTO materials (id) VALUES ('1ef03067-8c9f-5d10-bde1-e30a3b6ce80b'::uuid);
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT '2b1e5deb-1cfc-5ad8-80e0-c9048dab4ec3'::uuid, 'Materiale curs', NULL, '57e22219-d5c7-5e9b-a607-4d5a2b4b5c31'::uuid, id, '2026-07-01 09:08:16.376+00', '2026-07-01 09:08:16.376+00' FROM users;
INSERT INTO materials (id) VALUES ('2b1e5deb-1cfc-5ad8-80e0-c9048dab4ec3'::uuid);
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT 'a8103a34-9534-5ce1-b43d-37789270f6d9'::uuid, 'Exemple examene', NULL, '57e22219-d5c7-5e9b-a607-4d5a2b4b5c31'::uuid, id, '2026-07-01 09:10:27.977+00', '2026-07-01 09:10:27.977+00' FROM users;
INSERT INTO materials (id) VALUES ('a8103a34-9534-5ce1-b43d-37789270f6d9'::uuid);
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT 'a1bbb9a7-ff1a-5c2a-a2c1-34a77d245836'::uuid, 'Inregistrari cursuri', NULL, 'eb35afe4-3f24-52f6-95a6-3157e22afca2'::uuid, id, '2026-07-01 08:50:00.545+00', '2026-07-01 08:50:00.545+00' FROM users;
INSERT INTO materials (id) VALUES ('a1bbb9a7-ff1a-5c2a-a2c1-34a77d245836'::uuid);
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT 'b1bbfe9b-ace7-55dc-be82-c2d83af64d11'::uuid, 'Materiale curs', NULL, 'eb35afe4-3f24-52f6-95a6-3157e22afca2'::uuid, id, '2026-07-01 08:53:20.863+00', '2026-07-01 08:53:20.863+00' FROM users;
INSERT INTO materials (id) VALUES ('b1bbfe9b-ace7-55dc-be82-c2d83af64d11'::uuid);
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT '6184d9e0-a9fc-5e8c-accf-0afc2425b8c3'::uuid, 'Exemple examene', NULL, 'eb35afe4-3f24-52f6-95a6-3157e22afca2'::uuid, id, '2026-07-01 08:54:17.574+00', '2026-07-01 08:54:17.574+00' FROM users;
INSERT INTO materials (id) VALUES ('6184d9e0-a9fc-5e8c-accf-0afc2425b8c3'::uuid);
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT 'f9e3d720-0489-536a-9bdd-323da2775e16'::uuid, 'Materiale curs', NULL, '1fc619ee-1f40-5de8-aede-961ede74cff6'::uuid, id, '2026-07-01 09:08:16.376+00', '2026-07-01 09:08:16.376+00' FROM users;
INSERT INTO materials (id) VALUES ('f9e3d720-0489-536a-9bdd-323da2775e16'::uuid);
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT '688a67ff-4be3-556d-b4cc-422b8d352686'::uuid, 'Exemple examene', NULL, '1fc619ee-1f40-5de8-aede-961ede74cff6'::uuid, id, '2026-07-01 09:10:27.977+00', '2026-07-01 09:10:27.977+00' FROM users;
INSERT INTO materials (id) VALUES ('688a67ff-4be3-556d-b4cc-422b8d352686'::uuid);
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT '3d82d116-9b58-5abf-9478-9c5a4b643784'::uuid, 'Inregistrari cursuri', NULL, '1fc619ee-1f40-5de8-aede-961ede74cff6'::uuid, id, '2026-07-01 08:50:00.545+00', '2026-07-01 08:50:00.545+00' FROM users;
INSERT INTO materials (id) VALUES ('3d82d116-9b58-5abf-9478-9c5a4b643784'::uuid);
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT '71b86357-d0d7-55c2-99a8-1f4e37d4d844'::uuid, 'Materiale curs', NULL, 'ae7c4151-809c-5a61-99de-fa17c865bbc1'::uuid, id, '2026-07-01 09:08:16.376+00', '2026-07-01 09:08:16.376+00' FROM users;
INSERT INTO materials (id) VALUES ('71b86357-d0d7-55c2-99a8-1f4e37d4d844'::uuid);
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT '8981c6ad-10b7-5934-8745-ad03f1da349d'::uuid, 'Exemple examene', NULL, 'ae7c4151-809c-5a61-99de-fa17c865bbc1'::uuid, id, '2026-07-01 09:10:27.977+00', '2026-07-01 09:10:27.977+00' FROM users;
INSERT INTO materials (id) VALUES ('8981c6ad-10b7-5934-8745-ad03f1da349d'::uuid);
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT 'bf3728a7-cd1a-56ae-8a65-29d1ba616343'::uuid, 'Inregistrari cursuri', NULL, 'ae7c4151-809c-5a61-99de-fa17c865bbc1'::uuid, id, '2026-07-01 08:50:00.545+00', '2026-07-01 08:50:00.545+00' FROM users;
INSERT INTO materials (id) VALUES ('bf3728a7-cd1a-56ae-8a65-29d1ba616343'::uuid);
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT '4897f70b-0165-5a44-8a66-9f7e51008d03'::uuid, 'Materiale curs', NULL, '6c2459ac-96f0-5662-979a-33f0c103244e'::uuid, id, '2026-07-01 09:08:16.376+00', '2026-07-01 09:08:16.376+00' FROM users;
INSERT INTO materials (id) VALUES ('4897f70b-0165-5a44-8a66-9f7e51008d03'::uuid);
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT '5ed40275-de5a-5310-8da1-f5fd58e543e3'::uuid, 'Exemple examene', NULL, '6c2459ac-96f0-5662-979a-33f0c103244e'::uuid, id, '2026-07-01 09:10:27.977+00', '2026-07-01 09:10:27.977+00' FROM users;
INSERT INTO materials (id) VALUES ('5ed40275-de5a-5310-8da1-f5fd58e543e3'::uuid);
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT '6d3c949e-eaff-592c-9f29-de71fa8fd490'::uuid, 'Materiale curs', NULL, 'a3531d08-6838-5581-a366-ff7d0342fa00'::uuid, id, '2026-07-01 09:08:16.376+00', '2026-07-01 09:08:16.376+00' FROM users;
INSERT INTO materials (id) VALUES ('6d3c949e-eaff-592c-9f29-de71fa8fd490'::uuid);
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT 'ac1851a5-18bc-50fe-b792-0ff2d7928cf9'::uuid, 'Lista proiecte', NULL, 'a3531d08-6838-5581-a366-ff7d0342fa00'::uuid, id, '2026-07-01 09:10:27.977+00', '2026-07-01 09:10:27.977+00' FROM users;
INSERT INTO materials (id) VALUES ('ac1851a5-18bc-50fe-b792-0ff2d7928cf9'::uuid);
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT 'c003a1fb-9a27-549d-bc98-ddcd44971ab6'::uuid, 'Materiale curs', NULL, '8aa82ca0-1c94-535b-a59b-17855ff147b8'::uuid, id, '2026-07-01 09:08:16.376+00', '2026-07-01 09:08:16.376+00' FROM users;
INSERT INTO materials (id) VALUES ('c003a1fb-9a27-549d-bc98-ddcd44971ab6'::uuid);
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT '12dcc7d8-a676-5ec0-94e3-8a464fd49c6e'::uuid, 'Exemple examene', NULL, '8aa82ca0-1c94-535b-a59b-17855ff147b8'::uuid, id, '2026-07-01 09:10:27.977+00', '2026-07-01 09:10:27.977+00' FROM users;
INSERT INTO materials (id) VALUES ('12dcc7d8-a676-5ec0-94e3-8a464fd49c6e'::uuid);
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT '35a42333-1447-52fd-a99a-873257c56963'::uuid, 'Examen scris', 'Aveti voie cu materiale scrise de mana la examen', 'eb68cae4-f8ef-5276-970d-7f5761d64057'::uuid, id, '2026-07-01 09:11:18.827+00', '2026-07-01 09:11:18.827+00' FROM users;
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT '15ed5abc-0370-5d4d-8ea2-875c4902de23'::uuid, 'Examen scris', 'Nu aveti voie cu materiale scrise de mana la examen', 'a9e68b16-84c5-5698-8dd0-da7c73bcbe75'::uuid, id, '2026-07-01 09:11:18.827+00', '2026-07-01 09:11:18.827+00' FROM users;
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT 'a679d179-be17-5e11-82bc-fe01d09cd870'::uuid, 'Examen scris', 'Aveti voie cu materiale scrise de mana la examen', 'cc4ef83c-4cde-5974-9147-2728d60d9adb'::uuid, id, '2026-07-01 09:11:18.827+00', '2026-07-01 09:11:18.827+00' FROM users;
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT '1d6b133b-ca8b-5fa1-b27b-2181c48eec4d'::uuid, 'Examen scris', 'Nu aveti voie cu materiale scrise de mana la examen', 'c9cef1c1-3f4a-518a-92eb-3b6f482c6f4d'::uuid, id, '2026-07-01 09:11:18.827+00', '2026-07-01 09:11:18.827+00' FROM users;
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT 'bd6a020e-7f30-537f-b2bb-81f8e92aac8d'::uuid, 'Examen scris', 'Nu aveti voie cu materiale scrise de mana la examen', 'bb8e35b3-4c5d-533b-af0c-77d0213ce534'::uuid, id, '2026-07-01 09:01:18.325+00', '2026-07-01 09:01:18.325+00' FROM users;
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT 'd75fc805-3803-502e-9ba8-4b0c5dcb8461'::uuid, 'Examen pe calculator', 'Puteti veni cu latopul personal', 'af2fec30-b46e-5459-bec1-5d4f776b256f'::uuid, id, '2026-07-01 09:11:18.827+00', '2026-07-01 09:11:18.827+00' FROM users;
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT '49c48d59-f8b7-513a-a2d1-1ffdcad14391'::uuid, 'Prezentare proiect', 'Prezentarea se va sustine online. Trebuie sa luat jumatate din punctaj ca sa intrati in examenul pe calculator', 'af2fec30-b46e-5459-bec1-5d4f776b256f'::uuid, id, '2026-07-01 09:11:18.827+00', '2026-07-01 09:11:18.827+00' FROM users;
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT 'a1e0848d-6be3-554c-9fb6-4a9b48ca7c7f'::uuid, 'Prezentare proiect', 'Prezentarea se poate sustine online sau fizic. Daca nu stapaniti materia foarte bine, va sugerez sa mergeti fizic, deoarece aveti sanse mai mari sa treceti.', '0bea39fc-1412-5dab-b1d8-c34fa1601c16'::uuid, id, '2026-07-01 09:11:18.827+00', '2026-07-01 09:11:18.827+00' FROM users;
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT 'b589ce5a-8708-57d8-8af1-8f96ee76fb15'::uuid, 'Examen scris', 'Aveti voie cu materiale scrise de mana la examen', '2822d7db-1b2a-5dbb-b08f-e894f82f0590'::uuid, id, '2026-07-01 09:11:18.827+00', '2026-07-01 09:11:18.827+00' FROM users;
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT '70629015-e8f4-5367-abb4-003a1934943f'::uuid, 'Examen scris', 'Nu aveti voie cu materiale scrise de mana la examen', '0dcfccad-987a-5fd6-be57-104d2740c9f8'::uuid, id, '2026-07-01 09:11:18.827+00', '2026-07-01 09:11:18.827+00' FROM users;
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT '7d192339-b929-56cc-ac1a-a6a107947b5c'::uuid, 'Examen scris', 'Aveti voie cu materiale scrise de mana la examen', '7f8d88c0-9a96-5231-ada6-cafe37ad65f8'::uuid, id, '2026-07-01 09:11:18.827+00', '2026-07-01 09:11:18.827+00' FROM users;
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT '8ac11726-059b-5898-96c4-b2c6da14f586'::uuid, 'Examen scris', 'Aveti voie cu materiale scrise de mana la examen', 'e4e35737-598f-5778-a0ed-0bfb05e07197'::uuid, id, '2026-07-01 09:11:18.827+00', '2026-07-01 09:11:18.827+00' FROM users;
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT '51365991-3559-541f-8060-2f8338c06bd6'::uuid, 'Proiect mips', NULL, '3974654c-e940-5b4d-a7e3-76657f118864'::uuid, id, '2026-07-01 09:13:38.210+00', '2026-07-01 09:13:38.210+00' FROM users;
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT '9312d7ab-3f63-534a-a3c7-83877a23683d'::uuid, 'Proiect procese semnale si/sau tuburi', NULL, 'ec329b8c-e0d9-5d1e-a21f-a5648087783d'::uuid, id, '2026-07-01 09:13:38.210+00', '2026-07-01 09:13:38.210+00' FROM users;
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT 'a83e36d8-2a7e-5ad5-bc6c-627ed8eb81a8'::uuid, 'Tema lfa', NULL, '8ea1db2b-44e6-5025-bac4-e64d58871753'::uuid, id, '2026-07-01 09:13:38.210+00', '2026-07-01 09:13:38.210+00' FROM users;
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT 'b7edb0ab-06d0-504e-861f-d2c1f32173ec'::uuid, 'Teme colective lmc', 'Trei teme care valoreaza 1p fiecare si trebuie trimise doar de un membru al fiecarei grupe', '2b863ae6-80de-5e0c-aad5-b91a5a637693'::uuid, id, '2026-07-01 09:13:38.210+00', '2026-07-01 09:13:38.210+00' FROM users;
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT '7afffa03-284b-5eb3-9f54-aab9544222cd'::uuid, 'Proiect POO', 'Nota la proiect reprezinta nota finala trecuta in catalog', '6d95a562-5b21-57e6-96a3-783fbce44137'::uuid, id, '2026-07-01 09:13:38.210+00', '2026-07-01 09:13:38.210+00' FROM users;
...
INSERT INTO resources (id, title, description, folder_id, owner_id, created_at, updated_at)
SELECT '993f711f-264a-5833-a09b-6abece8fff08'::uuid, 'Teme colective sd', 'Tema care trebuie trimisa doar de un membru al fiecarei grupe', '9f351148-216f-586b-864b-cc63ca82c8fe'::uuid, id, '2026-07-01 09:13:38.210+00', '2026-07-01 09:13:38.210+00' FROM users;
