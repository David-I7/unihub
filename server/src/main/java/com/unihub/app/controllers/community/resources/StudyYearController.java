...
public class StudyYearController {
    ...
    public ResponseEntity<StudyYearCoursesResponseDto> getStudyYearCourses(
        ...
        StudyYearCoursesResponseDto studyYear = studyYearService.getStudyYearDetail(communitySlug, studyYearName, includeArchived);
