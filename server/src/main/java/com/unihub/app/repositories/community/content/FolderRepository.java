...
public interface FolderRepository extends JpaRepository<Folder, UUID> {
    ...
    List<Folder> findByCourseIdAndParentFolderId(@Param("courseId") int courseId, @Param("parentFolderId") UUID parentFolderId);
    ...
    List<Folder> findRootFoldersByCourseId(@Param("courseId") int courseId);

    boolean existsByIdAndCourseId(UUID id, int courseId);
}
