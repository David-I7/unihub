...
public class CalendarService {
    ...
    @Transactional
    public EventResponseDto createEvent(UUID userId, CreateEventRequestDto requestDto) {
    ...
    @Transactional
    public EventResponseDto updateEvent(UUID userId, UUID eventId, UpdateEventRequestDto requestDto) {
        Event event = eventRepository.findEventByIdWithDetails(eventId)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "Event not found"));
