...
public class CommunityPostServiceTests {
    ...
    @Test
    @DisplayName("getCommunityPosts returns posts with sorted comments and non-null fields")
    public void testGetCommunityPosts_Success() {
        ...
        PageDto<PostResponseDto> result = communityPostService.getCommunityPosts("fmi-info-id", pageRequest);
